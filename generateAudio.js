...
const SCRIPT_FILE = path.join(__dirname, 'Boys Script - OCR and edited.docx.txt');
const AUDIO_DIR = path.join(__dirname, 'audio');
const OUTPUT_JSON = path.join(__dirname, 'script.json');
const TEST_MODE = true;

// Map Character names to Google TTS Voices
const VOICE_MAP = {
    // Example: "CHARACTER NAME": "en-US-Neural2-A",
    "THE DIRECTOR": "en-US-Neural2-D",
    "NORMAN": "en-US-Neural2-J",
    "COP 1": "en-US-Neural2-I",
    "COP 2": "en-US-Neural2-A",
    "LEGACY REPORTER 1": "en-US-Neural2-F",
    "LEGACY REPORTER 2": "en-US-Neural2-C"
};
